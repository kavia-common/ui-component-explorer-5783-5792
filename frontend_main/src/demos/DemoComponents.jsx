...
export function CardDemo() {
  return (
    <div className="p-4 rounded-xl border bg-white w-full max-w-sm">
      ...
      <div className="mt-3">
        <button className="px-3 py-1.5 rounded-md bg-blue-600 text-white text-sm">Action</button>
      </div>
    </div>
  );
}
...
export function TextAreaDemo() {
  return <div className="space-y-2 w-full max-w-sm"><label className="text-sm font-medium">Message</label><textarea className="w-full px-3 py-2 rounded-lg border" rows="3" placeholder="Type..."></textarea></div>;
}
